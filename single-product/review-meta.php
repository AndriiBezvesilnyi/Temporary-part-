...
<?php } else { ?>
	...
	<p class="meta">
		...
		<time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo changeDateComment(get_comment_date( wc_date_format())); ?></time>
	</p>
